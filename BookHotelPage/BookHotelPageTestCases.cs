...
{
    [TestClass]
    public class BookHotelPageTestCases : ExtentReport
    {
        ...
        [TestMethod]
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", "Data.xml", "VisitBookHotelPageandClickOnSearchHotel", DataAccessMethod.Sequential)]
        public void VisitBookHotelPageandClickOnSearchHotel()
        {
            string url = TestContext.DataRow["url"].ToString();
            string username = TestContext.DataRow["username"].ToString();
            string password = TestContext.DataRow["password"].ToString();
            ...
            exChildTest = exParentTest.CreateNode("Visit Book Hotel Page and Click On Search Hotel Button");
            bookHotelPage.ClickOnSearchHotelLinkFromBookHotelPage(message4);
        }

        [TestMethod]
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", "Data.xml", "VisitBookHotelPageandClickOnOtherLinks", DataAccessMethod.Sequential)]
        public void VisitBookHotelPageandClickOnOtherLinks()
        {
            string url = TestContext.DataRow["url"].ToString();
            string username = TestContext.DataRow["username"].ToString();
            string password = TestContext.DataRow["password"].ToString();
            ...
            exChildTest = exParentTest.CreateNode("Book Hotel and Click On Other Links");
            bookHotelPage.ClickOnOtherLinksOfBookHotelPage();
        }

        [TestMethod]
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", "Data.xml", "VisitBookHotelPageandClickOnadactinWebLink", DataAccessMethod.Sequential)]
        public void VisitBookHotelPageandClickOnadactinWebLink()
        {
            string url = TestContext.DataRow["url"].ToString();
            string username = TestContext.DataRow["username"].ToString();
            string password = TestContext.DataRow["password"].ToString();
            ...
            exChildTest = exParentTest.CreateNode("Book Hotel and Click On Adactin Web Link");
            bookHotelPage.ClickOnAdactinWebLinkOfBookHotelPage();
        }

        [TestMethod]
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", "Data.xml", "VisitBookHotelPageandClickOnadactinCoLink", DataAccessMethod.Sequential)]
        public void VisitBookHotelPageandClickOnadactinCoLink()
        {
            string url = TestContext.DataRow["url"].ToString();
            string username = TestContext.DataRow["username"].ToString();
            string password = TestContext.DataRow["password"].ToString();
            ...
            exChildTest = exParentTest.CreateNode("Book Hotel and Click On Adactin Co Link");
            bookHotelPage.ClickOnAdactinCoLinkOfBookHotelPage();
        }
    }
}